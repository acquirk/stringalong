...
$result = mysql_query("SELECT url, urltime, urldate, title FROM quirktest")
or die(mysql_error());  
...
<iframe height="100%" width="100%" name="iframe" src="http://stringalong.bullemhead.com/start.php" scrolling="yes" title="escape(document.title)"></iframe>
